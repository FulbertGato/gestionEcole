...
$assistant= Session::getSession("user_connect");


?>

<div class="container">
    <form  action="<?php path ("assistant/update/".$assistant['id_assistant']);?>" method="post" enctype="multipart/form-data">
    <div class="main-body">
        <div class="row">
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <div class="mt-3">
                                <h4><?= $assistant["nom"]?> <?= $assistant["prenom"]?></h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                ...
                                <input type="hidden" id="id_assistant" name="id" value="<?= $assistant["id_assistant"]?>">
                            </div>
                        </div>
                        <div class="row">
